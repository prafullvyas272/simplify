...
<div style="border:none;width:100%;background-color:#dcb4e6;color:#333;font-family:Arial;font-size:14px;">
    ...
    <div style="padding:30px 20px 20px 20px;max-width:500px;margin:0px auto;background-color:#ffffff;">
        <div style="font-size:24px;font-family:Arial; text-align:center; font-weight:bold">
            ...
            <p>Topic: Coaching call with {{ $userName }}</p>
            <p>Start Time: {{ $formattedStartDate }}</p>
            <p>Duration: {{ $meeting['duration'] }} minutes</p>
            <p>Meeting Password: {{ $meeting['password'] ?? 'None' }}</p>
        </div>
        <div style="margin: 50px 0px; text-align: center">
            <a href="{{ $meeting['join_url'] }}" style="text-decoration:none;;margin:auto auto ; ;text-align:center;color:white; background-color:#170048; padding:20px 40px; border-radius:45px;"> Join Now </a>
        </div>
