                  ...
                  <div :class="childDetail.child_type === 'teen' ? 'no-cartoon':''" class="bg_congo">
                    <div class="congo_special">
                      ...
                      <div class=" mb-4">
                        ...
                        <Link class="commen_btn m-auto" :href="route('disc-assessments.before',this.childId)">{{childDetail.child_type === 'teen' ? "Ready to keep going? Let’s do this!":"Let's Go"}}</Link>
                      </div>
