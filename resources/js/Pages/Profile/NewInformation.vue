...
<!--        Side Menu-->
        <div class="w-48 mt-10 items-center flex-col flex space-y-10">
            <div class="group hover:cursor-pointer border border-gray-400 rounded " :class="{'button_gradient' : this.current_step==1}"  @click="this.current_step=1">
                <div class="bg-white rounded-[calc(0.3rem-1px)] py-4 w-28">
                    <svg  class="mx-auto" width="76" height="78" viewBox="0 0 76 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="group-hover:stroke-[#9645DF]" :class="{'stroke-[#9E9E9E]' : current_step!=1 , 'stroke-[#9645DF]': current_step ==1}"   d="M74.8626 76.879V76.8859H2C4.08876 70.9675 8.83048 66.1986 15.0253 64.2354L30.5979 59.2895V56.7053C28.6556 55.5548 26.9006 54.2318 25.46 53.2399C22.7798 51.4273 20.9941 48.5772 20.4617 45.3778L19.6307 40.3851C17.03 40.3851 14.931 38.2735 14.931 35.6573V24.6311C14.931 18.1089 17.5624 12.2009 21.8081 7.91594C26.0707 3.64698 31.9295 1 38.4319 1C51.4049 1 61.9339 11.5868 61.9339 24.6311V35.6573C61.9339 38.2735 59.8338 40.3851 57.233 40.3851L56.4032 45.3778C55.8708 48.5772 54.0692 51.4273 51.3902 53.2399C49.9485 54.2159 48.2241 55.5548 46.2659 56.7053V59.2895L61.8249 64.2354C68.0265 66.1986 72.7716 70.9641 74.8626 76.879Z" stroke-width="2" stroke-miterlimit="10"/>
                    </svg>
                </div>
            </div>
            <div :class="{'button_gradient' : this.current_step==2}" class="group hover:cursor-pointer border border-gray-400 rounded " @click="this.current_step=2">
                <div   class="bg-white rounded-[calc(0.3rem-1px)] py-4 w-28">
                    <svg class="mx-auto" width="92" height="64" viewBox="0 0 92 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="group-hover:stroke-[#9645DF]" :class="{'stroke-[#9E9E9E]' : current_step!=2 , 'stroke-[#9645DF]': current_step ==2}" d="M46.0145 1.5957L90.4293 15.9855L46.0145 30.4044L31.6459 25.7335L1.59973 15.9855L46.0145 1.5957Z"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path class="group-hover:stroke-[#9645DF]" :class="{'stroke-[#9E9E9E]' : current_step!=2 , 'stroke-[#9645DF]': current_step ==2}" d="M71.2033 23.4414V39.4849M20.7967 39.3979V23.4414M71.2033 39.4559C71.2033 42.154 59.9178 46.6218 46.0146 46.6218C32.1113 46.6218 20.8258 42.154 20.8258 39.4559M46.0146 15.9854L26.3813 24.0216V62.4042"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
        ...
        <div class="w-full px-20 hidden flex-wrap" :class="{'!flex': this.current_step===1 }" >
            <div class="w-full mb-10">
                <h2 class="text-2xl font-bold">About you</h2>
            </div>

            <div class="w-1/2 flex px-10 items-center flex-col">
                <div class="rounded-xl" >

                    <svg v-if="this.$page.props.auth.user.image=='/users-avatar/placeholder.png'" width="301" height="301" viewBox="0 0 301 301" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="301" height="301" rx="20" fill="#DEDEDE"/>
                        <g clip-path="url(#clip0_0_1)">
                            <path d="M272 301H27C28.3595 298.721 29.2773 297.107 29.5807 296.412C37.2768 278.755 52.308 264.733 71.4945 258.67L123.643 242.196V233.589C117.107 229.704 111.265 225.262 106.449 222.007C97.4899 215.963 91.4605 206.483 89.6786 195.816L86.8944 179.17C78.1844 179.17 71.1488 172.13 71.1488 163.415C71.1488 156.932 75.0353 151.38 80.6077 148.959C75.7419 137.535 72.1665 125.427 70.0198 113.011C68.6564 105.145 67.8884 96.8491 70.1964 89.2638C72.4968 81.6784 78.6068 75.023 85.8075 74.8924L86.7523 74.9577C91.2992 67.8527 98.4078 63.1724 105.862 60.4672C113.32 57.7581 121.193 56.8397 128.996 55.9444C132.046 55.5909 135.106 55.2374 138.179 54.9299C152.346 53.5658 167.772 53.2315 182.258 57.2701C196.748 61.3087 210.746 70.3619 218.127 84.7948C223.984 96.2458 225.174 110.06 223.7 123.129C222.724 131.802 220.647 140.244 218.208 148.579C224.287 150.757 228.623 156.571 228.623 163.415C228.623 172.13 221.591 179.17 212.874 179.17L210.093 195.816C208.311 206.483 202.286 215.963 193.326 222.007C188.507 225.262 182.669 229.704 176.133 233.589V242.196L228.277 258.67C249.1 265.248 265.026 281.199 272 301Z" fill="#9E9E9E"/>
                        </g>
                        <defs>
                            <clipPath id="clip0_0_1">
                                <rect width="245" height="247" fill="white" transform="translate(27 54)"/>
                            </clipPath>
                        </defs>
                    </svg>

                    <div class="w-full" v-else >
                        <img :src="'/storage/'  + this.$page.props.auth.user.image" class="max-h-48" alt="">
                    </div>

                </div>

                <p class="text-gray-400 text-xs mt-2">
                    Upload a clear and recent photo of yourself. Smile!
                </p>

                <div class="w-full max-w-[250px] py-2 button_gradient !rounded-3xl mt-8">
                    <input type="file" id="files" class="hidden "
                            @change="handleFileUpload($event,'image')"
                            @input="user_information_form.image = $event.target.files[0]"
                           required
                    />
                    <label for="files" class="w-full mx-auto block text-center
                    max-w-[250px] py-2 text-gray-400 font-bold
                    cursor-pointer bg-white rounded-[calc(250px-1px)] text-xl "
                    >{{this.user_information_form.image?.name ?? "Edit Picture"}} </label>

                </div>

                <div class="w-full flex flex-col space-y-2 transition-all  items-center mt-10">
                    <InputLabel class="!text-xl font-bold text-center " value="Date of birth"/>
                    ...
                    <inputField
                        id="name"
                        type="date"
                        class="w-full max-w-[250px] border-2 border-gray-300 "
                        :max="max_date"
