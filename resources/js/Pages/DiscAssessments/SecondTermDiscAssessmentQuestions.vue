    ...
    export default {
        ...
        data() {
            return {
                ...
                showInfoModal: false,
                term: 2   //term will be 2 for second  term assessments
            };
        },
        methods: {
            keepOpen() {
                                    ...
                                    if (response.data.status === "Success") {
                                        ...
                                        axios
                                            .post(route('user-report.store'), {
                                                ...
                                                window.location.href = `/second-term/welcome/${this.childDetail.id}`;
                                        })
                                    }
                                })
                                .catch((error) => {
            ...
            fetchQuestions() {
                ...
                var getQuestionUrlEndPoint = this.assessmentApiUrl + `disc?type=${userType}` + `&part=2` ;   //part=2 for second term assessments questions
